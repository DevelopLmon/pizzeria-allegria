...
const liquidbuttonVariants = cva(
  "inline-flex items-center justify-center cursor-pointer gap-2 whitespace-nowrap rounded-full font-medium border border-white/30 hover:bg-white/10 transition-colors duration-500 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-2 focus-visible:ring-white/50",
  {
    variants: {
      variant: {
        default: "",
        destructive: "border-red-400/40 hover:bg-red-500/10",
        outline: "",
        secondary: "",
        ghost: "border-transparent",
        link: "border-transparent underline-offset-4 hover:underline hover:bg-transparent",
      },
      size: {
    ...
    <div className={variants.wrapper} style={variants.wrapperStyle}>
      ...
      >
        ...
        {isHovered && !isPressed && !isTouchDevice && (
          <div className="pointer-events-none absolute inset-0 bg-linear-to-t rounded-lg from-transparent to-white/5" />
        )}
      </button>
    </div>
  );
